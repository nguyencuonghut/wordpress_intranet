...
class WP_ProfitMag_Recent_Posts extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array('classname' => 'profitmag_widget_recent_entries', 'description' => __( "Display recent posts with thumbnail and date of post.", 'profitmag' ) );
		parent::__construct('profitmag-recent-posts', __('Profitmag: Recent Posts', 'profitmag'), $widget_ops);
