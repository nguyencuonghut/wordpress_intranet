...
function profitmag_customize_register( $wp_customize ) {
  ...
  $wp_customize->add_section('profitmag_header_section', array(    
    'title'       => __('Header', 'profitmag-pro'),
    'panel'       => 'profitmag_basic_panel'    
  ));

  // Main logo of the site
  $wp_customize->add_setting('profitmag_theme_options[profitmag_logo_setting]', array(
    'default'           => '',
    'type'              => 'theme_mod',
  ...
  $wp_customize->add_control(
       new WP_Customize_Image_Control(
           $wp_customize,
           'profitmag_theme_options[profitmag_logo_setting]',
           array(
               'label'        => __( 'Upload Logo', 'profitmag-pro' ),                
               'settings'     => 'profitmag_theme_options[profitmag_logo_setting]',
  ...
  $wp_customize->add_setting('profitmag_theme_options[profitmag_logo_options]', array(
    'default'         => __('title', 'profitmag-pro'), 
    'type'            => 'theme_mod',
    'capability'      => 'edit_theme_options',
    'theme_supports'  => '',
    'transport'       => 'refresh',
  ...
  $wp_customize->add_control('profitmag_theme_options[profitmag_logo_options]', array(      
    'label'   => __('Select Image or Site title for logo of the site', 'profitmag-pro'),    
    'settings'=> 'profitmag_theme_options[profitmag_logo_options]',
    'section' => 'profitmag_header_section',
    'type'    => 'radio',
    'choices' => array(         
                  'logo'    => __('Logo (Upload logo if you select this option)', 'profitmag-pro'),
                  'title'   => __('Site Title (Site title and description will be used if you select this option)', 'profitmag-pro'),
                  'disable' => __('Disable', 'profitmag-pro'),
                )
  ));
  ...
  $wp_customize->add_control( 'profitmag_theme_options[profitmag_header_ads_setting]', array(
    'label'       => __('Header Ads', 'profitmag-pro'),
    'description' => __('Please insert the image of size 790X90px', 'profitmag-pro'), 
  ...
  $wp_customize->add_control('profitmag_theme_options[profitmag_homeicon_setting]', array(
    'label'       => __('Check to show home icon in navigation bar', 'profitmag-pro'),   
  ...
  $wp_customize->add_control('profitmag_theme_options[profitmag_menu_setting]', array(      
    'label'   => __('Menu Alignment', 'profitmag-pro'),    
    'settings'=> 'profitmag_theme_options[profitmag_menu_setting]',
    'section' => 'profitmag_header_section',
    'type'    => 'select',
    'choices' => array(         
                  'Left'  => __('Left', 'profitmag-pro'),
                  'Right' => __('Right', 'profitmag-pro')
                )
  ));
  ...
  $wp_customize->add_control('profitmag_theme_options[profitmag_search_setting]', array(
    'label'       => __('Check to enable search in navigation bar', 'profitmag-pro'),   
  ...
  $wp_customize->add_section('profitmag_footer_section', array(    
    'title'       => __('Footer', 'profitmag-pro'),
    'panel'       => 'profitmag_basic_panel'    
  ));

  // Footer Copyright
  $wp_customize->add_setting('profitmag_theme_options[profitmag_copyright_setting]', array(
    'default'           =>  __('Copyright 2016. All rights reserved', 'profitmag-pro'),
    'type'              => 'theme_mod',
    'capability'        => 'edit_theme_options',
    'theme_supports'    => '',
    'transport'         => 'refresh',
  ...
  $wp_customize->add_control('profitmag_theme_options[profitmag_copyright_setting]', array(
    'label'       => __('Copyright Text', 'profitmag-pro'),    
  ...
  $wp_customize->add_section('profitmag_general_section', array(    
    'title'       => __('General', 'profitmag-pro'),
    'panel'       => 'profitmag_basic_panel'    
  ));
  ...
  $wp_customize->add_control('profitmag_theme_options[profitmag_responsive_setting]', array(
    'label'     => __('Check to disable Responsive Layout', 'profitmag-pro'),
  ...
  $wp_customize->add_control('profitmag_theme_options[profitmag_postdate_setting]', array(
    'label'     => __('Check to hide Posted Date', 'profitmag-pro'),    
  ...
  $wp_customize->add_control('profitmag_theme_options[profitmag_layoutcolor_setting]', array(      
    'label'   => __('Color Scheme', 'profitmag-pro'),    
    'settings'=> 'profitmag_theme_options[profitmag_layoutcolor_setting]',
    'section' => 'profitmag_general_section',
    'type'    => 'select',
    'choices' => array(         
                  'red'       => __('Red', 'profitmag-pro'),
                  'blue'      => __('Blue', 'profitmag-pro'),                  
                  'orange'    => __('Orange', 'profitmag-pro'),                 
                )
  ));

  // Web Page Layout    
  $wp_customize->add_setting('profitmag_theme_options[profitmag_layout_setting]', array(
    'default'         => __('Fullwidth', 'profitmag-pro'), 
    'type'            => 'theme_mod',
    'capability'      => 'edit_theme_options',
    'theme_supports'  => '',
    'transport'       => 'refresh',
  ...
  $wp_customize->add_control('profitmag_theme_options[profitmag_layout_setting]', array(      
    'label'   => __('Web Page Layout', 'profitmag-pro'),    
    'settings'=> 'profitmag_theme_options[profitmag_layout_setting]',
    'section' => 'profitmag_general_section',
    'type'    => 'radio',
    'choices' => array(         
                  'Fullwidth'  => __('Full Width', 'profitmag-pro'),
                  'Boxed'       => __('Boxed', 'profitmag-pro')
                )
  ));  
  ...
  $wp_customize->add_control('profitmag_theme_options[profitmag_readmore_setting]', array(
    'label'       => __('Read More Text in Archive Pages', 'profitmag-pro'),  
    'description' => __('Change text if you want to use other than "Read More"', 'profitmag-pro'),   
  ...
  //For Custom CSS 
  $wp_customize->add_setting( 'profitmag_theme_options[profitmag_custom_css_setting]', array(
    'default'               => '',
    'type'                  => 'theme_mod',
    'capability'            => 'edit_theme_options',
    'theme_supports'        => '',
    'transport'             => 'refresh',
    'sanitize_callback'     => 'profitmag_sanitize_css',
    'sanitize_js_callback'  => 'profitmag_sanitize_css'
  ) );

  $wp_customize->add_control('profitmag_theme_options[profitmag_custom_css_setting]', array(
    'label'     => __('Custom CSS', 'profitmag-pro'),
    'description'   => __( 'Enter custom css here', 'profitmag-pro' ),   
    'settings'  => 'profitmag_theme_options[profitmag_custom_css_setting]',
    'section'   => 'profitmag_general_section',
    'type'      => 'textarea'
  )); 
  ...
  $wp_customize->add_section('profitmag_slider_section', array(    
    'title'       => __('Slider Block', 'profitmag-pro'),
    'panel'       => 'profitmag_basic_panel',      
  ));
  ...
  $wp_customize->add_control('profitmag_theme_options[profitmag_slider_type_setting]', array(      
    'label'   => __('Show Slide From', 'profitmag-pro'),    
    'settings'=> 'profitmag_theme_options[profitmag_slider_type_setting]',
    'section' => 'profitmag_slider_section',
    'type'    => 'radio',
    'choices' => array(         
                  'single_post_slider'  => __('Single Posts', 'profitmag-pro'),
                  'cat_post_slider'     => __('Category Posts', 'profitmag-pro')
                )
  ));
  ...
  $wp_customize->add_control(
    new Profitmag_Customize_Info_Control(
        ...
        array(
            'label'       => __( 'Select the post for Slider', 'profitmag-pro' ),            
    ...
    $wp_customize->add_control(
      new Profitmag_Customize_Slider_Posts_Control(
          ...
          array(
              'label'       => __( 'Select Post', 'profitmag-pro' ),            
  ...
  $wp_customize->add_control(
    new Profitmag_Customize_Category_Control(
        ...
        array(
            'label'       => __( 'Select Category', 'profitmag-pro' ),
            'description' => __( 'Posts of selected category will be used as slider', 'profitmag-pro' ),
  ...
  $wp_customize->add_control('profitmag_theme_options[profitmag_slider_arrow_setting]', array(      
    'label'   => __('Show or Hide Slider Controls (Arrows)', 'profitmag-pro'),    
    'settings'=> 'profitmag_theme_options[profitmag_slider_arrow_setting]',
    'section' => 'profitmag_slider_section',
    'type'    => 'radio',
    'choices' => array(         
                  'yes' => __('Show', 'profitmag-pro'),
                  'no'  => __('Hide', 'profitmag-pro')
                )
  ));
  ...
  $wp_customize->add_control('profitmag_theme_options[profitmag_slider_transition_setting]', array(      
    'label'   => __('Enable Slider auto Transition?', 'profitmag-pro'),    
    'settings'=> 'profitmag_theme_options[profitmag_slider_transition_setting]',
    'section' => 'profitmag_slider_section',
    'type'    => 'radio',
    'choices' => array(         
                  'yes' => __('Yes', 'profitmag-pro'),
                  'no'  => __('No', 'profitmag-pro')
                )
  ));
  ...
  $wp_customize->add_control('profitmag_theme_options[profitmag_slider_speed_setting]', array(      
    'label'   => __('Enter slider speed', 'profitmag-pro'),
  ...
  $wp_customize->add_control(
    new Profitmag_Customize_Category_Control(
        ...
        array(
            'label'       => __( 'Featured Block Category', 'profitmag-pro' ),
            'description' => __( 'Section Beside Slider', 'profitmag-pro' ),
  ...
  $wp_customize->add_section('profitmag_homepage_section', array(    
    'title'   => __('Home Page Blocks', 'profitmag-pro'),
    'panel'   => 'profitmag_basic_panel'
  ));
  ...
  $wp_customize->add_control(
    new Profitmag_Customize_Category_Control(
        ...
        array(
            'label'        => __( 'Featured Block One Category', 'profitmag-pro' ),
            'description'  => __( 'Section Below Slider', 'profitmag-pro' ),
  ...
  $wp_customize->add_control('profitmag_theme_options[profitmag_fbxonepostnum_setting]', array(      
    'label'   => __('No. of posts to display', 'profitmag-pro'),
  ...
  $wp_customize->add_control(
    new Profitmag_Customize_Category_Control(
        ...
        array(
            'label'        => __( 'Featured Block Two Category', 'profitmag-pro' ),
            'description'  => __( 'Section Below Featured Block One', 'profitmag-pro' ),
  ...
  $wp_customize->add_control(
    new Profitmag_Customize_Category_Control(
        ...
        array(
            'label'        => __( 'Featured Block Three Category', 'profitmag-pro' ),
            'description'  => __( '5 Columns Block', 'profitmag-pro' ),
  ...
  $wp_customize->add_control( 'profitmag_theme_options[profitmag_home_ads_setting]', array(
    'label'       => __('Home Page Ads ( Mid Section )', 'profitmag-pro'),
    'description' => __('Please insert the image of size 855X91px', 'profitmag-pro'), 
  ...
  $wp_customize->add_control(
    new Profitmag_Customize_Category_Control(
        ...
        array(
            'label'        => __( 'Featured Block Four Category', 'profitmag-pro' ),
            'description'  => __( 'Excerpt Posts', 'profitmag-pro' ),
  ...
  $wp_customize->add_control(
    new Profitmag_Customize_Category_Control(
        ...
        array(
            'label'        => __( 'Featured Block Five Left', 'profitmag-pro' ),
            'description'  => __( 'Left Column', 'profitmag-pro' ),
  ...
  $wp_customize->add_control(
    new Profitmag_Customize_Category_Control(
        ...
        array(
            'label'        => __( 'Featured Block Five Right', 'profitmag-pro' ),
            'description'  => __( 'Right Column', 'profitmag-pro' ),
  ...
  $wp_customize->add_control(
    ...
    'profitmag_theme_options[profitmag_gallery_setting]', 
      array(
        'type' => 'gallery-image',
        'label' => __('Select Gallery Images', 'profitmag-pro'),
        'section' => 'profitmag_homepage_section',
  ...
  $wp_customize->add_section('profitmag_social_section', array(    
    'title'       => __('Social Links', 'profitmag-pro'),
    'panel'       => 'profitmag_basic_panel'    
  ));
  ...
  $wp_customize->add_control('profitmag_theme_options[profitmag_social_op_setting]', array(
    'label'     => __('Social icons of header', 'profitmag-pro'),
    'description'   => __( 'Check here to disable social icons of header', 'profitmag-pro' ),   
  ...
  $wp_customize->add_control('profitmag_theme_options[profitmag_social_foot_setting]', array(
    'label'     => __('Social icons of footer', 'profitmag-pro'),
    'description'   => __( 'Check here to disable social icons of footer', 'profitmag-pro' ),   
  ...
  foreach($social_options as $social) {
    ...
    switch ($social) {
      ...
      case 'facebook':
        $label = __('Facebook', 'profitmag-pro');
        break;

      case 'twitter':
        $label = __( 'Twitter', 'profitmag-pro' );
        break;

      case 'google_plus':
        $label = __( 'Google Plus', 'profitmag-pro' );
        break;

      case 'youtube':
        $label = __( 'Youtube', 'profitmag-pro' );
        break;

      case 'pinterest':
        $label = __( 'Pinterest', 'profitmag-pro' );
        break;

      case 'flickr':
        $label = __( 'Flickr', 'profitmag-pro' );
        break;

      case 'vimeo':
        $label = __( 'Vimeo', 'profitmag-pro' );
        break;

      case 'stumbleupon':
        $label = __( 'Stumbleupon', 'profitmag-pro' );
        break;

      case 'dribble':
        $label = __( 'Dribble', 'profitmag-pro' );
        break;

      case 'tumblr':
        $label = __( 'Tumblr', 'profitmag-pro' );
        break;

      case 'linkedin':
        $label = __( 'Linkedin', 'profitmag-pro' );
        break;

      case 'sound_cloud':
        $label = __( 'Sound Cloud', 'profitmag-pro' );
        break;

      case 'skype':
        $label = __( 'Skype', 'profitmag-pro' );
        break;

      case 'rss':
        $label = __( 'RSS', 'profitmag-pro' );
        break;
  ...
  $wp_customize->add_section('profitmag_blog_section', array(    
    'title'       => __('Blog Setting', 'profitmag-pro'),
    'panel'       => 'profitmag_basic_panel'    
  ));
  ...
  $wp_customize->add_control(
    ...
    'profitmag_theme_options[profitmag_sidebar_layout_setting]', 
      array(
        'type' => 'radio-image',
        'label' => __('Blog layout', 'profitmag-pro'),
    ...
    $wp_customize->add_section('profitmag_leftsidebar_section', array(    
      'title'   => __('Left Sidebar', 'profitmag-pro'),
      'panel'   => 'profitmag_basic_panel'
    ));
    ...
    $wp_customize->add_control(
      new Profitmag_Customize_Category_Control(
          ...
          array(
              'label'        => __( 'Category Post One', 'profitmag-pro' ),           
  ...
  $wp_customize->add_control( 'profitmag_theme_options[profitmag_left_mid_ads_setting]', array(
    'label'       => __('Middle Ads', 'profitmag-pro'),
    'description' => __('Please insert the image of size 302X222px', 'profitmag-pro'), 
  ...
  $wp_customize->add_control(
    ...
    'profitmag_theme_options[profitmag_left_gallery_setting]', 
      array(
        'type' => 'gallery-image',
        'label' => __('Photo Gallery', 'profitmag-pro'),
        'section' => 'profitmag_leftsidebar_section',
  ...
  $wp_customize->add_setting('profitmag_theme_options[profitmag_leftsidebar_bottom_setting]', array(
    ...
    $wp_customize->add_control(
      new Profitmag_Customize_Category_Control(
          ...
          array(
              'label'        => __( 'Category Post Two', 'profitmag-pro' ),           
  ...
  $wp_customize->add_control( 'profitmag_theme_options[profitmag_left_bottom_ads_setting]', array(
    'label'       => __('Bottom Ads One', 'profitmag-pro'),
    'description' => __('Please insert the image of size 302X592px', 'profitmag-pro'), 
  ...
  $wp_customize->add_control( 'profitmag_theme_options[profitmag_left_bottom_ads_two_setting]', array(
    'label'       => __('Bottom Ads Two', 'profitmag-pro'),
    'description' => __('Please insert the image of size 302X592px', 'profitmag-pro'), 
  ...
  //Right Sidebar Settings Starts 
    $wp_customize->add_section('profitmag_rightsidebar_section', array(    
      'title'   => __('Right Sidebar', 'profitmag-pro'),
      'panel'   => 'profitmag_basic_panel'
    ));
  ...
  $wp_customize->add_section('profitmag_about_section', array(    
    'title'       => __('About Theme', 'profitmag-pro'),
    'priority' => 3098,    
  ));
  ...
  $wp_customize->add_control(
    new Profitmag_About_Theme(
      ...
      array(
        'label' => __('Important Links', 'profitmag-pro'),        
