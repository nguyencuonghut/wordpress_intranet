...
function profitmag_setup() {
     ...
     */
    add_image_size( 'profitmag-logo', 400, 150 );
    add_theme_support( 'custom-logo', array( 'size' => 'profitmag-logo' ) );
...
function profitmag_default_menu_fallback(){
	...
	echo '<ul id="menu-main-menu" class="menu">';
		echo '<li class="menu-item"><a href="' . esc_url( home_url( '/' ) ) . '">' . __( 'Home', 'profitmag' ). '</a></li>';
		wp_list_pages( array(
			'title_li' => '',
			'depth'    => 1,
			'number'   => 5,
...
/**
 * Theme Options to Customizer conversion
 */
require get_template_directory() . '/inc/admin-panel/conversion.php';
