	...
	<header id="masthead" class="site-header clearfix" role="banner">
            ...
            <div class="wrapper">
                        ...
                        ?>
                                <div class="header-latest-posts f-left">                                                                    
                                   <div class="latest-post-title">latest post</div>
                        ...
                        ?>
                                    ...
                                    <?php foreach( $recent_posts as $recent ): ?>
                                            ...
                                            <li><a href="<?php echo esc_url( get_permalink( $recent["ID"] ) ); ?>" title="<?php echo esc_attr( $recent['post_title'] ); ?>"><?php echo esc_attr( $recent['post_title'] ); ?></a></li>
        ...
        <div class="wrapper header-wrapper clearfix">
        		<div class="header-container"> 
                    ...
                    <div class="site-branding clearfix">
            			<div class="site-logo f-left">
                                ...
                                if( 'title' === $logo_options ){ ?>
                                    ...
                                    } elseif ( 'logo' === $logo_options &&  !empty($theme_options['profitmag_logo_setting'])){ ?>
                                        <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
                                            <img src="<?php echo esc_url( $theme_options['profitmag_logo_setting'] ); ?>" alt="<?php bloginfo('name') ?>" />
                                        </a>                                
                                    <?php 
                                    } 
                                }
            		...
            		<nav id="site-navigation" class="main-navigation <?php echo $nav_class; ?> clearfix <?php do_action( 'profitmag_menu_alignment' ); ?>" role="navigation" >
