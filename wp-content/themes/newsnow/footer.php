	...
	<footer id="colophon" class="site-footer">
		...
		<div id="site-bottom" class="clear">
			...
			<div class="site-info">
				...
				<?php 
					$theme_uri = 'https://www.happythemes.com/wordpress-themes/newsnow';
					$author_uri = 'https://www.happythemes.com/';
				?>

				&copy; <?php echo date("o"); ?> <a href="<?php echo home_url(); ?>"><?php echo get_bloginfo('name'); ?></a> - <?php echo __('Theme by', 'newsnow'); ?> <a href="<?php echo $author_uri; ?>" target="_blank">HappyThemes</a>
