...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'newsnow' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'newsnow' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'newsnow' ),
		'cyrillic'     => __( 'Cyrillic', 'newsnow' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'newsnow' ),
		'devanagari'   => __( 'Devanagari', 'newsnow' ),
		'greek'        => __( 'Greek', 'newsnow' ),
		'greek-ext'    => __( 'Greek Extended', 'newsnow' ),
		'khmer'        => __( 'Khmer', 'newsnow' ),
		'latin'        => __( 'Latin', 'newsnow' ),
		'latin-ext'    => __( 'Latin Extended', 'newsnow' ),
		'vietnamese'   => __( 'Vietnamese', 'newsnow' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'newsnow' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'newsnow' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'newsnow' ),
